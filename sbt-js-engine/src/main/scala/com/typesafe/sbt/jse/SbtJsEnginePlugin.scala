...
object SbtJsEnginePlugin extends sbt.Plugin {
  ...
  object JsEngineKeys {
    ...
    val npmPackageJsonLastModified = TaskKey[Long]("jse-npm-package-json-last-modified", "Yields the time that the package.json file was last modified")
  }
  ...
  val jsEngineSettings: Seq[Setting[_]] = Seq(
    ...
    npmPackageJsonLastModified := (baseDirectory.value / PackageJson).lastModified()
